...
class Superheterodyne_HIFI_decoder(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.filter_delay = filter_delay = 42
        ...
        self._filter_delay_range = Range(0, 26*2, 1, 42, 200)
        self._filter_delay_win = RangeWidget(self._filter_delay_range, self.set_filter_delay, 'EQ Delay', "counter_slider", float)
        self.tabs_layout_3.addWidget(self._filter_delay_win)
        ...
        self.qtgui_number_sink_0_1_1.set_title("Level-Meter")
        ...
        self.blocks_multiply_const_vxx_8 = blocks.multiply_const_ff(right_squelch)
        self.blocks_multiply_const_vxx_7 = blocks.multiply_const_ff(1 - left_squelch)
        self.blocks_multiply_const_vxx_6 = blocks.multiply_const_ff(1 - right_squelch)
        self.blocks_multiply_const_vxx_5 = blocks.multiply_const_ff(left_squelch)
        ...
        self.blocks_delay_1_0 = blocks.delay(gr.sizeof_float*1, filter_delay)
        self.blocks_delay_1 = blocks.delay(gr.sizeof_float*1, filter_delay)
        ...
        self.blocks_add_xx_3_1 = blocks.add_vff(1)
        self.blocks_add_xx_3_0_0 = blocks.add_vff(1)
        ...
        self.connect((self.analog_rail_ff_1_1_1, 0), (self.blocks_multiply_const_vxx_5, 0))
        ...
        self.connect((self.analog_rail_ff_1_1_1_0, 0), (self.blocks_multiply_const_vxx_8, 0))
        ...
        self.connect((self.blocks_add_xx_3_0_0, 0), (self.low_pass_filter_0, 0))
        self.connect((self.blocks_add_xx_3_1, 0), (self.low_pass_filter_0_0, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_delay_0, 0), (self.blocks_multiply_const_vxx_7, 0))
        self.connect((self.blocks_delay_0_0, 0), (self.blocks_multiply_const_vxx_6, 0))
        self.connect((self.blocks_delay_1, 0), (self.blocks_add_xx_3_1, 0))
        self.connect((self.blocks_delay_1, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_delay_1_0, 0), (self.blocks_add_xx_3_0_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_6, 0), (self.blocks_add_xx_2_0, 2))
        self.connect((self.blocks_multiply_const_vxx_7, 0), (self.blocks_add_xx_2, 2))
        self.connect((self.blocks_multiply_const_vxx_8, 0), (self.blocks_add_xx_2_0, 1))
        ...
        self.connect((self.high_pass_filter_0, 0), (self.low_pass_filter_1, 0))
        self.connect((self.high_pass_filter_0_0, 0), (self.low_pass_filter_1_0, 0))
        ...
        self.connect((self.low_pass_filter_1, 0), (self.blocks_add_xx_3_1, 1))
        self.connect((self.low_pass_filter_1, 0), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.low_pass_filter_1_0, 0), (self.blocks_add_xx_3_0_0, 1))
        ...
        self.connect((self.rational_resampler_xxx_1_0, 0), (self.blocks_delay_1_0, 0))
        self.connect((self.rational_resampler_xxx_1_0, 0), (self.blocks_null_sink_0, 1))
        self.connect((self.rational_resampler_xxx_1_0, 0), (self.high_pass_filter_0_0, 0))
    ...
    def set_audio_rate(self, audio_rate):
        ...
        self.set_pop_len(self.audio_rate*(self.pop_time/2))
        self.high_pass_filter_0.set_taps(firdes.high_pass(1, self.audio_rate, 300, 200, firdes.WIN_KAISER, 6.76))
        self.high_pass_filter_0_0.set_taps(firdes.high_pass(1, self.audio_rate, 300, 200, firdes.WIN_KAISER, 6.76))
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.audio_rate, 300, 70e3, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.audio_rate, 300, 70e3, firdes.WIN_HAMMING, 6.76))
        ...
        self.low_pass_filter_1.set_taps(firdes.low_pass(-1, self.audio_rate, 1e3, 3e3, firdes.WIN_KAISER, 6.76))
        self.low_pass_filter_1_0.set_taps(firdes.low_pass(-1, self.audio_rate, 1e3, 3e3, firdes.WIN_KAISER, 6.76))
    ...
    def set_right_squelch(self, right_squelch):
        ...
        self.blocks_multiply_const_vxx_8.set_k(self.right_squelch)
    ...
    def set_left_squelch(self, left_squelch):
        ...
        self.blocks_multiply_const_vxx_5.set_k(self.left_squelch)
        self.blocks_multiply_const_vxx_7.set_k(1 - self.left_squelch)
    ...
    def set_filter_delay(self, filter_delay):
        ...
        self.blocks_delay_1.set_dly(self.filter_delay)
        self.blocks_delay_1_0.set_dly(self.filter_delay)
